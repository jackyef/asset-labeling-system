...
<div class="row">
    <div class="col-sm-12">
    <a href="<?= base_url().'employee'?>"><button class="btn btn-primary"><span class="fa fa-backward"></span> Back to employee list</button></a>
    <h2>Edit employee</h2>
    <br/>
    <form class="form-horizontal" action="<?php echo base_url(); ?>employee/edit/submit/<?= $record->id ?>" method="POST">
