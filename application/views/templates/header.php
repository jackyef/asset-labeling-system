    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li><a href="<?= base_url().'assembled-item'?>">Assembled Item <span class="label label-warning">70%</span></a></li>
                <li><a href="<?= base_url().'mutation-history'?>">Mutation History <span class="label label-success">done</span></a></li>
