...
<div class="row">
    ...
    <br/>
    <form class="form-horizontal" action="<?php echo base_url(); ?>master/ssub-location/new/submit" method="POST">
        <div class="form-group">
            <label class="control-label col-sm-2" for="name">Name:</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" id="name" name="name" placeholder="Ex: Section A, Section Z, IT Dept., etc" required>
            </div>
        </div>
        <div class="form-group">
